...
module Navigation = {
  ...
  let make = () =>
    <nav className="p-2 h-12 flex border-b border-gray-200 justify-between items-center text-sm">
      <Link className=Some("flex items-center w-1/3") href="/">
      ...
      <div className="flex w-2/3 justify-end">
        <Link className=Some("px-3") href="/"> {React.string("Home")} </Link>
        <Link className=Some("px-3") href="/examples"> {React.string("Examples")} </Link>
        <a
